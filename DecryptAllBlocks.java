...
public class DecryptAllBlocks 
{
	...
	public static ArrayList<String> decrypt(ArrayList<String> cipherBlocks, String keyString){
		ArrayList<String> decryptedBlocks = new ArrayList<String>();
		int	key = Hex16.convert(keyString);
	...
	public static ArrayList<String> getCipherBlocks(String fileIn) throws FileNotFoundException{
